...
namespace MonitorSystem.Dqfh
{
    ...
    /// 电气符号
    /// </summary>
    public class Dqfh19 : MonitorControl
    {
        ...
        private static readonly DependencyProperty BackColorProperty =
           ...
           typeof(Color), typeof(Dqfh19), new PropertyMetadata(Colors.White));
        ...
        private static readonly DependencyProperty ForeColorProperty =
            ...
            typeof(Color), typeof(Dqfh19), new PropertyMetadata(Colors.Black));
        ...
        typeof(int), typeof(Dqfh19), new PropertyMetadata(0));
        ...
        private void Paint()
        {
            ...
            pc.Add(new Point(this.Width / 2, this.Height * 0.6));
            pc.Add(new Point(this.Width * 0.1436, this.Height * 0.8));
            pc.Add(new Point(this.Width * 0.833, this.Height * 0.8));
            py.Points = pc;

            //三线
            _Line1.X1 = _Line1.X2 = this.Width / 2;
            _Line1.Y1 = this.Height * 0.224;
            _Line1.Y2 = this.Height * 0.384;

            _Line2.X1 = this.Width / 2;
            _Line2.Y1 = this.Height * 0.224;
            _Line2.X2 = this.Width * 0.224;
            _Line2.Y2 = this.Height * 0.1;

            _Line3.X1 = this.Width / 2;
            _Line3.Y1 = this.Height * 0.224;
            _Line3.X2 = this.Width * 0.71;
            _Line3.Y2 = this.Height * 0.1;
        }
    }
}
