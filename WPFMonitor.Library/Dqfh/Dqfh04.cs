...
namespace MonitorSystem.Dqfh
{
    ...
    /// 电气符号
    /// </summary>
    public class Dqfh04 : MonitorControl
    {
        ...
        public Dqfh04()
        {
            ...
            _Line1.Stroke = _Line2.Stroke = _Line3.Stroke = _Line4.Stroke = _Line5.Stroke =
                 _Line6.Stroke = new SolidColorBrush(DQFHCommon.DQFHLineColor);
        ...
        {
            this.Width = e.NewSize.Height * 0.61;
        ...
        private static readonly DependencyProperty BackColorProperty =
           ...
           typeof(Color), typeof(Dqfh04), new PropertyMetadata(Colors.White));
        ...
        private static readonly DependencyProperty ForeColorProperty =
            ...
            typeof(Color), typeof(Dqfh04), new PropertyMetadata(Colors.Black));
        ...
        typeof(int), typeof(Dqfh04), new PropertyMetadata(0));
        ...
        private void Paint()
        {
            ...
            _Line1.Y1 = 0;
            _Line1.Y2 = this.Height * 0.4;

            _Line2.X1 = _Line2.X2 = this.Width / 2;
            _Line2.Y1 = this.Height * 0.65;
            _Line2.Y2 = this.Height;
            //中间线
            _Line3.X1 = 0;
            _Line3.X2 = this.Width;
            _Line3.Y1 = _Line3.Y2 = this.Height * 0.4;

            _Line4.X1 = this.Width * 0.238;
            _Line4.X2 = this.Width * 0.728;
            _Line4.Y1 = _Line4.Y2 = this.Height * 0.48;

            _Line5.X1 = 0;
            _Line5.X2 = this.Width;
            _Line5.Y1 = _Line5.Y2 = this.Height * 0.56;

            _Line6.X1 = this.Width * 0.238;
            _Line6.X2 = this.Width * 0.728;
            _Line6.Y1 = _Line6.Y2 = this.Height * 0.64;
        }
    }
}
