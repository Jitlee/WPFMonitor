...
namespace WPFMonitor.Library.Dqfh
{
    ...
    /// 电气符号
    /// </summary>
    public class Dqfh14 : MonitorControl
    {
        ...
        {
            this.Width = e.NewSize.Height * 0.83;
        ...
        private static readonly DependencyProperty BackColorProperty =
           ...
           typeof(Color), typeof(Dqfh14), new PropertyMetadata(Colors.White));
        ...
        private static readonly DependencyProperty ForeColorProperty =
            ...
            typeof(Color), typeof(Dqfh14), new PropertyMetadata(Colors.Black));
        ...
        typeof(int), typeof(Dqfh14), new PropertyMetadata(0));
        ...
        private void Paint()
        {
            ...
            pc.Add(new Point(this.Width /2, this.Height* 0.72));
            pc.Add(new Point(this.Width * 0.244, this.Height));
            py.Points = pc;

            //中间线
            _Line1.X1 = _Line1.X2 = this.Width / 2;
            _Line1.Y1 = this.Height * 0.15;
            _Line1.Y2 = this.Height;
