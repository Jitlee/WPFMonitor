...
namespace WPFMonitor.Library.Dqfh
{
    ...
    /// 电气符号
    /// </summary>
    public class Dqfh13 : MonitorControl
    {
        ...
        public Dqfh13()
        {
            ...
            RectY.Fill = new SolidColorBrush(DQFHCommon.DQFHFilleColor);
            _canvas.Children.Add(RectY);
        ...
        {
            this.Width = e.NewSize.Height * 0.69;
        ...
        private static readonly DependencyProperty BackColorProperty =
           ...
           typeof(Color), typeof(Dqfh13), new PropertyMetadata(Colors.White));
        ...
        private static readonly DependencyProperty ForeColorProperty =
            ...
            typeof(Color), typeof(Dqfh13), new PropertyMetadata(Colors.Black));
        ...
        typeof(int), typeof(Dqfh13), new PropertyMetadata(0));
        ...
        private void Paint()
        {
            ...
            double YWidth = this.Height * 0.45;
            RectY.Width = RectY.Height = RectY.RadiusX = RectY.RadiusY = YWidth;
            RectY.SetValue(Canvas.LeftProperty, this.Width / 2 - YWidth / 2);
            RectY.SetValue(Canvas.TopProperty, this.Height - YWidth);

            //中间线
            _Line1.X1 = _Line1.X2 = this.Width / 2;
            _Line1.Y1 = this.Height * 0.11;
            _Line1.Y2 = this.Height * 0.55;

            _Line2.X1 = this.Width * 0.05;
            _Line2.Y1 = this.Height * 0.265;
            _Line2.X2 = this.Width * 0.887;
            _Line2.Y2 = 0;
            double RectWidth = this.Height * 0.1;

            _rect1.SetValue(Canvas.TopProperty, this.Height * 0.27);
