...
namespace MonitorSystem.Dqfh
{
    ...
    /// 电气符号
    /// </summary>
    public class Dqfh09 : MonitorControl
    {
        ...
        private static readonly DependencyProperty BackColorProperty =
           ...
           typeof(Color), typeof(Dqfh09), new PropertyMetadata(Colors.White));
        ...
        private static readonly DependencyProperty ForeColorProperty =
            ...
            typeof(Color), typeof(Dqfh09), new PropertyMetadata(Colors.Black));
        ...
        typeof(int), typeof(Dqfh09), new PropertyMetadata(0));
        ...
        private void Paint()
        {
            ...
            pc.Add(new Point(this.Width * 0.176,0));
            pc.Add(new Point(this.Width * 0.78,0));
            pc.Add(new Point(this.Width * 0.78, this.Height));
            py.Points = pc;

            _Line1.X1 = this.Width * 0.05;
            _Line1.X2 = this.Width * 0.95;
            _Line1.Y1 = _Line1.Y2 = 0;


            double RectWidth = this.Width * 0.1;
            _rect1.Width = _rect1.Height = _rect1.RadiusX = _rect1.RadiusY = RectWidth;

            _rect2.SetValue(Canvas.LeftProperty, this.Width * 0.9);
