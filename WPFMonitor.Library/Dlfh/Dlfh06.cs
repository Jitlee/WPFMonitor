...
{
    public class Dlfh06 : MonitorControl
    {
        ...
        private void Dlfh06_SizeChanged(object sender, SizeChangedEventArgs e)
        {
        ...
        private static readonly DependencyProperty BackColorProperty =
           ...
           typeof(Color), typeof(Dlfh06), new PropertyMetadata(Colors.White));
        ...
        private static readonly DependencyProperty ForeColorProperty =
            ...
            typeof(Color), typeof(Dlfh06), new PropertyMetadata(Colors.Black));
        ...
        typeof(int), typeof(Dlfh06), new PropertyMetadata(0));
      ...
      typeof(int), typeof(Dlfh06), new PropertyMetadata(0));
        ...
        private void Paint()
        {
            ...
            //40--50--60
            _LineJD3.Y1 = _LineJD3.Y2 =this.Height- _GroundWireWidth / 2;
            _LineJD3.X1 = this.Width * 0.25;
            _LineJD3.X2 = this.Width * 0.75;

            _LineJD2.Y1 = _LineJD2.Y2 = this.Height * ( 5d / 6d);
            _LineJD2.X1 = this.Width * 0.1;
            _LineJD2.X2 = this.Width * 0.9;


            _LineJD1.Y1 = _LineJD1.Y2 = this.Height * 0.67;
            _LineJD1.X1 = 0;
