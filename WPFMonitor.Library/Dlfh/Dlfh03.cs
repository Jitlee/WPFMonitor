...
{
    public class Dlfh03: MonitorControl
    {
        ...
        public Dlfh03()
        {
            ...
            this.SizeChanged += new SizeChangedEventHandler(Dlfh03_SizeChanged);
        }

        private void Dlfh03_SizeChanged(object sender, SizeChangedEventArgs e)
        {
        ...
        private static readonly DependencyProperty BackColorProperty =
           ...
           typeof(Color), typeof(Dlfh03), new PropertyMetadata(Colors.White));
        ...
        private static readonly DependencyProperty ForeColorProperty =
            ...
            typeof(Color), typeof(Dlfh03), new PropertyMetadata(Colors.Black));
        ...
        typeof(int), typeof(Dlfh03), new PropertyMetadata(0));
      ...
      typeof(int), typeof(Dlfh03), new PropertyMetadata(0));
        ...
        private void Paint()
        {
            ...
            _LineJD1.X1 = _LineJD1.X2 = this.Width * 0.67;
            _LineJD1.Y1 = 0;
            _LineJD1.Y2 = this.Height;

            _LineJD2.X1 = _LineJD2.X2 = this.Width * (5d/6d);
            _LineJD2.Y1 = this.Height*0.1;
            _LineJD2.Y2 = this.Height*0.9;

            _LineJD3.X1 = _LineJD3.X2 = this.Width-(_GroundWireWidth/2);
