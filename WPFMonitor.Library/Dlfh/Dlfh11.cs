...
namespace MonitorSystem.Dlfh
{
    ...
    /// 电力符号 11 电抗器1
    /// </summary>
    public class Dlfh11 : MonitorControl
    {
        ...
        public Dlfh11()
        {
            ...
            Paint();
            PaintNormal();
            this.SizeChanged += new SizeChangedEventHandler(Dlfh11_SizeChanged);
        }



        private void Dlfh11_SizeChanged(object sender, SizeChangedEventArgs e)
        {
     ...
     typeof(int), typeof(Dlfh11), new PropertyMetadata(0));
        ...
        private static readonly DependencyProperty BackColorProperty =
           ...
           typeof(Color), typeof(Dlfh11), new PropertyMetadata(Colors.White));
        ...
        private static readonly DependencyProperty ForeColorProperty =
            ...
            typeof(Color), typeof(Dlfh11), new PropertyMetadata(Colors.Black));
      ...
      typeof(int), typeof(Dlfh11), new PropertyMetadata(0));
       ...
       py.Stroke = plRight.Stroke = _LineLeft.Stroke = new SolidColorBrush(_LineColor);
        ...
        private void Paint()
        {
            ...
            _LineLeft.X1 = 0;
            _LineLeft.X2 = this.Width* 0.25;

            PointCollection pc = new PointCollection();
            pc.Add(new Point(this.Width/2,0));
            pc.Add(new Point(this.Width/2,this.Height/2));
            pc.Add(new Point(this.Width, this.Height / 2));
            plRight.Points = pc;
            ...
            pf.StartPoint = new Point(this.Width * 0.25, this.Height / 2);
            psc.Clear();
            ...
            arcs = new ArcSegment();
            arcs.Point = new Point(this.Width * 0.75, this.Height / 2);
            arcs.Size = arcsSize;
            psc.Add(arcs);
