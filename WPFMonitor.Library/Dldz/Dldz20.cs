...
namespace WPFMonitor.Library.Dldz
{
    ...
    /// 电力电子20
    /// </summary>
    public class Dldz20 : MonitorControl
    {
        ...
        public Dldz20()
        {
            ...
            //线
            _Line1.Stroke = _Line2.Stroke = _Line3.Stroke = gy.Stroke = new SolidColorBrush(DLDZCommon.DLDZLineColor);

            _Line1.StrokeThickness = _Line2.StrokeThickness = _Line3.StrokeThickness =
                gy.StrokeThickness = DLDZCommon.DLDZLineWidth;
        ...
        private static readonly DependencyProperty BackColorProperty =
           ...
           typeof(Color), typeof(Dldz20), new PropertyMetadata(Colors.White));
        ...
        private static readonly DependencyProperty ForeColorProperty =
            ...
            typeof(Color), typeof(Dldz20), new PropertyMetadata(Colors.Black));
        ...
        typeof(int), typeof(Dldz20), new PropertyMetadata(0));
        ...
        private void Paint()
        {
            ...
            gy.Points = pc;
            pc.Add(new Point(this.Width * 0.4, 0));
            pc.Add(new Point(this.Width * 0.4, this.Height));
