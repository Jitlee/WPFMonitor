...
namespace MonitorSystem.Dldz
{
    ...
    /// 电力电子
    /// </summary>
    public class Dldz10 : MonitorControl
    {
        ...
        private void Control_SizeChanged(object sender, SizeChangedEventArgs e)
        {
            ...
            this.Height = e.NewSize.Width * 0.58;
            Paint();
        }
        ...
        private static readonly DependencyProperty BackColorProperty =
           ...
           typeof(Color), typeof(Dldz10), new PropertyMetadata(Colors.White));
        ...
        private static readonly DependencyProperty ForeColorProperty =
            ...
            typeof(Color), typeof(Dldz10), new PropertyMetadata(Colors.Black));
        ...
        typeof(int), typeof(Dldz10), new PropertyMetadata(0));
        ...
        private void Paint()
        {
            ...
            psc.Add(arcs);
             ...
             arcs = new ArcSegment();
            arcs.Point = new Point(this.Width * 0.8, this.Height* 0.1);
            psc.Add(arcs);
            //最近面中间点
            arcs = new ArcSegment();
            ...
            arcs = new ArcSegment();
            arcs.Point = new Point(this.Width * 0.97, this.Height* 0.632);
            psc.Add(arcs);

            //下面
            arcs = new ArcSegment();
            arcs.Point = new Point(this.Width * 0.61, this.Height);
            arcs.Size = new Size()
            {
                Height = this.Height/2 ,
                Width = this.Width * 0.39
            ...
            arcs = new ArcSegment();
            arcs.Point = new Point(this.Width * 0.03, this.Height* 0.9);
            psc.Add(arcs);

            //前面中间
            arcs = new ArcSegment();
            arcs.Point = new Point(this.Width * 0.11, this.Height/2);

            psc.Add(arcs);

            arcs = new ArcSegment();
            arcs.Point = new Point(this.Width * 0.05, this.Height * 0.138);
            psc.Add(arcs);
