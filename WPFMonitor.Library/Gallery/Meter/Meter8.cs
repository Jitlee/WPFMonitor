        ...
        private void PaintCalibration(Size size)
        {
            try
            {
                ...
                for (int i = 0; i <= mainScale; i++)
                {
                    ...
                    text.SetValue(Canvas.LeftProperty, Math.Sin(mainAngle) * width * 367d / 657d - textSize.Width / 2d + width * 0.5d);
                    text.SetValue(Canvas.TopProperty, Math.Cos(mainAngle) * width * 367d / 657d - textSize.Height / 2d + width * 461d / 657d);
